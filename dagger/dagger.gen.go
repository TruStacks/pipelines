...
type GoGolangCilintOpts = dagger.GoGolangCilintOpts

// GoGotestsumOpts contains options for Go.Gotestsum
type GoGotestsumOpts = dagger.GoGotestsumOpts

// GoTestOpts contains options for Go.Test
type GoTestOpts = dagger.GoTestOpts
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "TrustacksGolangApi":
		...
		case "Build":
			...
			return nil, (*TrustacksGolangApi).Build(&parent)
		case "GolangCilint":
			var parent TrustacksGolangApi
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
